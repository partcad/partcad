...
_OPERATIONS = {
    ...
    "init.package": operations.init_package,
    ...
    "system.reset": operations.system_reset,
    "system.status": operations.system_status,
    "system.set.telemetry": operations.system_set_telemetry,
