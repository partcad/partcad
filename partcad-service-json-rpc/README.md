...
else's installation. The implementation is `partcad_client.selfupdate`; the way to run it is `pc upgrade`,
...
Finding and stopping daemons is `partcad_client.daemon` for the same reason. What is here is the serving
