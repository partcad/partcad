...
def _bom_line(item) -> dict:
    ...
    # How the process is set up, which the geometry does not carry: a nozzle
    # diameter, a layer height, an infill, a surface finish. PartCAD does not
    # interpret any of it - it is what a shop is told, and a parts list is where
    # whoever makes the part reads it.
    line["process"] = manufacturing.get("parameters") or None
