...
def init_sentry(version: str) -> None:
    ...
    if not sentry_sdk.is_initialized() and user_config.telemetry_config.sentry_dsn:
        ...
        sentry_sdk.init(
            ...
            dsn=user_config.telemetry_config.sentry_dsn,
            release=version,
            environment=user_config.telemetry_config.environment,
            debug=user_config.telemetry_config.debug,
            shutdown_timeout=user_config.telemetry_config.sentry_shutdown_timeout,
            attach_stacktrace=user_config.telemetry_config.sentry_attach_stacktrace,
            traces_sample_rate=user_config.telemetry_config.sentry_traces_sample_rate,
        ...
        if user_config.telemetry_config.performance or user_config.telemetry_config.failures:
