...
class PartFactoryBuild123d(PartFactoryPython):
    ...
    async def instantiate(self, part):
        ...
        with pc_logging.Action("Build123d", part.project_name, part.name):
            ...
            register_ocp_helper()
            with pc_tracer.start_as_current_span("*PartFactoryBuild123d.instantiate.{pickle.dumps}"):
            ...
            @pc_tracer.start_as_current_span("PartFactoryBuild123d.instantiate.process")
