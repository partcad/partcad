...
from partcad import logging as pc_logging, part_config
from partcad.part_factory import part_factory as pf
...
ENRICH = PartTypes.ENRICH

@register_factory(ENRICH.type)
