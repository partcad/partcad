...
from partcad import logging as pc_logging, runtime
from partcad.part_factory.part_factory_step import PartFactoryStep
...
class PartFactoryKicad(PartFactoryStep):
    ...
    async def instantiate(self, part):
        ...
        with pc_logging.Action("KiCad", part.project_name, part.name):
            kicad_pcb_path = part.path.replace(".step", f".{KICAD.ext}")
