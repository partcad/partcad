...
from partcad.part_factory.part_factory_ai_cadquery import PartFactoryAiCadquery
from partcad.part_factory.part_factory_ai_openscad import PartFactoryAiScad
...
def test_scad_ai_script_header():
    ...
    with patch("partcad.part_factory.part_factory_feature_ai.Git", return_value=MagicMock(config=MagicMock(return_value="Mock Author"))):
