...
name. `partcad/src/partcad_ide_client` is a relative symlink to `./src/partcad_ide_client`, so this source
...
`partcad/tests/unit/test_ide_client_is_shipped.py` is the guard. See "The PartCAD IDE viewer client" in
