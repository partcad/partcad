...
Feature: `pc render` command
  ...
  Scenario: Troubleshooting: Command Line
    ...
    #   """
    # Then the command should exit with a status code of "0"
    When I run "pc render -t stl /pub/robotics/parts/gobilda:structure/u_channel_2"
    Then the command should exit with a status code of "0"
    When I run "pc render -t step -a /pub/robotics/parts/gobilda:examples/wormgear"
    Then the command should exit with a status code of "0"
    When I run "pc render -P /pub/robotics/parts/gobilda -t stl structure/u_channel_2"
    Then the command should exit with a status code of "0"
    When I run "pc render -P /pub/robotics/parts/gobilda -t step -a examples/wormgear"
    Then the command should exit with a status code of "0"
