...
[![CI on Linux](https://github.com/partcad/partcad/actions/workflows/dev-container.yml/badge.svg?event=schedule)](https://github.com/openvmp/partcad/actions/workflows/dev-container.yml?query=event%3Aschedule)
[![CD on Linux, MacOS and Windows](https://github.com/openvmp/partcad/actions/workflows/python-build.yml/badge.svg?event=schedule)](https://github.com/openvmp/partcad/actions/workflows/python-build.yml?query=event%3Aschedule)
