...
``pc render``
  ...
  **The bill of materials is what a published parts list has in it.** Beside the name, the count and the
  ...
  +---------------+------------------------------------------------------------------------------------+
  | ``Process``   || ``manufacturing: parameters:`` -- how the process is set up (see                   |
  |               || :ref:`manufacturing-parameters`). One cell, because which parameters a process     |
  |               || has is the process's business.                                                     |
  +---------------+------------------------------------------------------------------------------------+
